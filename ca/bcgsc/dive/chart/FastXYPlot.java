...
/*
 * Original written by: Lindsay Pender
 * Last known contributors: "nonlinear5" and "CameO73"
 * Taken from: http://www.jfree.org/phpBB2/viewtopic.php?f=3&t=18592&hilit=fast+classes&start=45
 * Last modified on January 21, 2010 by: Ka Ming Nip - fixed the bug where the line connecting to the "last" item was not drawn
 */
/**
                    ...
                    for (int series = seriesCount - 1; series >= 0; series--) {
                        ...
                        if (state.getProcessVisibleItemsOnly()) {
                            ...
                            if (lastItem < dataset.getItemCount(series) - 1) {
                                lastItem++; //added by KMN: adds an extra item at the end so lines continue to the edge of plots
                            }
                        }
