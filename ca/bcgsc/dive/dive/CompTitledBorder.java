...
/**
 * Original code (version: 1.0 08/12/99) was part of the Tame Swing collection.
 * Author of original code: Nobuo Tamemasa
 *
 * Modified by Ka Ming Nip
 */
public class CompTitledBorder extends TitledBorder {
  ...
  public void paintBorder(Component c, Graphics g,
    ...
    // paints the component onto the border
    component.setSize(component.getPreferredSize());
    BufferedImage img = new BufferedImage(component.getPreferredSize().width, component.getPreferredSize().height, BufferedImage.TYPE_INT_ARGB);
    Graphics2D g2 = img.createGraphics();
    component.paint(g2);
    g2.dispose();
    g.drawImage(img, compR.x, compR.y, null);
  }
