 ...
 *
 */
public class MyDefaultParallelEdgeIndexFunction<V,E> implements EdgeIndexFunction<V,E>
{
    protected Map<Context<Graph<V,E>,E>, Integer> edge_index = new HashMap<Context<Graph<V,E>,E>, Integer>();

    private MyDefaultParallelEdgeIndexFunction() {
    }
     ...
     */
    public static <V,E> MyDefaultParallelEdgeIndexFunction<V,E> getInstance() {
        return new MyDefaultParallelEdgeIndexFunction<V,E>();
    }
